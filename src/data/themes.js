...
export const themes = [
  ...
  { id: 'drive', icon: '🚗', label: { ko: '드라이브', en: 'Drive', ja: 'ドライブ', zh: '自驾游' } },
  { id: 'flower', icon: '🌸', label: { ko: '꽃', en: 'Flower', ja: '花', zh: '花' } },
  { id: 'autumn_leaves', icon: '🍁', label: { ko: '단풍', en: 'Autumn Leaves', ja: '紅葉', zh: '红叶' } },
  { id: 'sea', icon: '🏖', label: { ko: '해변', en: 'Beach', ja: 'ビーチ', zh: '海滩' } },
  { id: 'traditional', icon: '🏯', label: { ko: '전통', en: 'Traditional', ja: '伝統', zh: '传统' } },
  { id: 'field', icon: '🌾', label: { ko: '들판', en: 'Field', ja: '野原', zh: '田野' } },
  { id: 'hiking', icon: '🥾', label: { ko: '등산', en: 'Hiking', ja: '登山', zh: '徒步' } },
  { id: 'forest', icon: '🌲', label: { ko: '숲', en: 'Forest', ja: '森', zh: '森林' } },
]
